        ...
        <div id="containerLogin">
            ...
            <div id="formContainer">
                <form class="form" method='POST' action="/api/users/">
                    ...
                    <div>
                        <button class="bg-slate-400 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded shadow-lg">LOG IN</button>
                        <a class="text-white pl-5 underline" href="#">Register now</a>
                    </div>
                </form>
                <div id="iconUser">
